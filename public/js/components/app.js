...
var _reactDatepicker = __webpack_require__(17);
...
var Layout = function (_Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function apiCall() {
      //
      var self = this;
      _axios2.default.get('https://min-api.cryptocompare.com/data/pricehistorical?fsym=BTC&tsyms=BTC,USD,EUR&ts=1513311738&extraParams=crypto_profits_cp').then(function (response) {
        self.setState({
